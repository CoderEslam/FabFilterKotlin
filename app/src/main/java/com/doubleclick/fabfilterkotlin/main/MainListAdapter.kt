...
class MainListAdapter(context: Context) : RecyclerView.Adapter<MainListAdapter.ListViewHolder>() {
    ...
    private val originalBg: Int = context.resources.getColor(R.color.list_item_bg_collapsed);
    private val expandedBg: Int = context.resources.getColor(R.color.list_item_bg_expanded)
