...
import com.doubleclick.fabfilterkotlin.crystalrangeseekbar.widgets.CrystalSeekbar
import com.google.android.material.appbar.AppBarLayout
import com.doubleclick.fabfilterkotlin.filter.FiltersLayout
import com.doubleclick.fabfilterkotlin.filter.FiltersMotionLayout
...
//    private val filtersMotionLayout: FiltersMotionLayout by bindView(R.id.filters_motion_layout)
    ...
    private val loadingDuration: Long
        get() = 10// (resources.getInteger(R.integer.loadingAnimDuration) / animationPlaybackSpeed).toLong()
