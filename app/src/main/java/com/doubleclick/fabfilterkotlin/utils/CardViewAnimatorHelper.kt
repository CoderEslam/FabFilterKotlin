package com.doubleclick.fabfilterkotlin.utils

import android.animation.TimeInterpolator
import android.animation.ValueAnimator
import android.view.animation.AccelerateDecelerateInterpolator
import androidx.cardview.widget.CardView
import com.doubleclick.fabfilterkotlin.utils.ArcAnimator.ArcMetric
import com.doubleclick.fabfilterkotlin.utils.ArcAnimator.ArcUtils
import com.doubleclick.fabfilterkotlin.utils.ArcAnimator.Side
    ...
    var progress: Float = 0f
        set(value) {
            ...
            if (!isArcPath) {
                ...
                cardView.x = arcMetric.getAxisPoint()!!.x + arcMetric.mRadius * ArcUtils.cos(degree)
                cardView.y = arcMetric.getAxisPoint()!!.y - arcMetric.mRadius * ArcUtils.sin(degree)
            }
