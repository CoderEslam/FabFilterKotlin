...
import com.doubleclick.fabfilterkotlin.main.MainListAdapter
import com.doubleclick.fabfilterkotlin.main.animationPlaybackSpeed
import com.doubleclick.fabfilterkotlin.views.MultiListenerMotionLayout
...
class FiltersMotionLayout @JvmOverloads constructor(
    ...
    init {
        var view: View = inflate(context, R.layout.layout_filter_motion, this)
