...
import com.doubleclick.fabfilterkotlin.utils.setScale

class FiltersTabsAdapter(context: Context, private val listener: (Int) -> Unit) :
    RecyclerView.Adapter<FiltersTabsAdapter.FiltersTabsViewHolder>() {
    ...
    class FiltersTabsViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val badge: View = itemView.findViewById(R.id.tab_badge)
    }
