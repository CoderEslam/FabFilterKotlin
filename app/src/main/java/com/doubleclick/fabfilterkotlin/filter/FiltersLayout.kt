...
import com.doubleclick.fabfilterkotlin.main.MainActivity
import com.doubleclick.fabfilterkotlin.main.animationPlaybackSpeed
import com.doubleclick.fabfilterkotlin.utils.*
import com.doubleclick.fabfilterkotlin.views.NoScrollRecyclerView
...
class FiltersLayout @JvmOverloads constructor(
    ...
    private val bottomBarColor: Int
    private val bottomBarPinkColor: Int
    private val bgColor: Int
    private val filterIconColor: Int
    private val filterIconActiveColor: Int

    private var fabSize: Float = 0f
    private var fabSizeInset: Float
    private var fabElevation: Float
    private var fabElevation2: Float
    private var fabPressedElevation: Float
    private var fabMargin: Float = 0f
    private var tabsHeight: Float
    ...
    init {
        val view: View = inflate(context, R.layout.layout_filter, this)
        fab = view.findViewById(R.id.fab);
        fabFilterIcon = view.findViewById(R.id.fab_filter_icon)
        fabCloseIcon = view.findViewById(R.id.fab_close_icon)
        ...
        bottomBarCardView = view.findViewById(R.id.bottom_bar_card_view)
        ...
        //////////////////////////////////////////////////////////////////////
        bottomBarColor = context.resources.getColor(R.color.bottom_bar_color)
        bottomBarPinkColor = context.resources.getColor(R.color.colorAccent)
        bgColor = context.resources.getColor(R.color.colorPrimaryDark)
        filterIconColor = context.resources.getColor(R.color.filter_icon_color)
        filterIconActiveColor = context.resources.getColor(R.color.filter_icon_active_color)
        /////////////////////////////////////////////////////////////////////
        fabSize = context.resources.getDimension(R.dimen.fab_size)
        fabSizeInset = context.resources.getDimension(R.dimen.fab_size_inset)
        fabElevation = context.resources.getDimension(R.dimen.fab_elevation)
        fabElevation2 = context.resources.getDimension(R.dimen.fab_elevation_2)
        fabPressedElevation = context.resources.getDimension(R.dimen.fab_pressed_elevation)
        fabMargin = context.resources.getDimension(R.dimen.fab_margin)
        tabsHeight = context.resources.getDimension(R.dimen.tabs_height)
        ///////////////////////////////////////////////////////////////////
        tabsHandler.init()
