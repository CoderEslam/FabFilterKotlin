...
import com.doubleclick.fabfilterkotlin.views.NoScrollHorizontalLayoutManager
...
class ViewPagerTabsHandler(
    ...
    private val bottomBarColor: Int = context.resources.getColor(R.color.bottom_bar_color)
    private val bottomBarPinkColor: Int = context.resources.getColor(R.color.colorAccent)
    private val tabColor: Int = context.resources.getColor(R.color.tab_unselected_color)
    private val tabSelectedColor: Int = context.resources.getColor(R.color.tab_selected_color)

    private val tabItemWidth: Float = context.resources.getDimension(R.dimen.tab_item_width)
    private val filterLayoutPadding: Float =
        context.resources.getDimension(R.dimen.filter_layout_padding)
    ...
    fun init() {
        ...
        viewPager.registerOnPageChangeCallback(object : ViewPager2.OnPageChangeCallback() {
            override fun onPageScrolled(
                ...
                val currentTabView =
                    tabsRecyclerView.layoutManager?.findViewByPosition(position) ?: return
    ...
    private fun onFilterSelected(updatedPosition: Int, selectedMap: Map<Int, List<Int>>) {
        ...
        bottomBarAnimator?.let {
            ...
            it.duration = toggleAnimDuration.toLong()
            it.start()
        }
    }
}